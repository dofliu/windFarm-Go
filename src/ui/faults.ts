...
// 進行中工單（A1）。targetFault 決定維修畫面要解哪個故障。
export const ACTIVE_QUEST: Quest = {
  id: "q_ch12",
  title: { zh: "更換偏航電機 · CH-12 號機組", en: "Service Unit CH-12" },
  brief: { zh: "前往「彰化外海・CH-12」，於浪高 1.5m 內排除齒輪箱過熱告警並回報 SCADA。", en: "Sail to Changhua Offshore CH-12; clear the gearbox overheat alarm within 1.5m wave height and report to SCADA." },
  unit: "CH-12",
  targetFault: "gearbox_overheat",
  rewardBudget: 180_000,
  rewardXp: 120,
};
